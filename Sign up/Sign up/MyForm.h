...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// registration
			// 
			this->registration->BackColor = System::Drawing::Color::Yellow;
			this->registration->Font = (gcnew System::Drawing::Font(L"MS UI Gothic", 18, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(128)));
			this->registration->Location = System::Drawing::Point(794, 650);
			this->registration->Name = L"registration";
			this->registration->Size = System::Drawing::Size(135, 65);
			this->registration->TabIndex = 40;
			this->registration->Text = L"登録";
			...
			this->title->Size = System::Drawing::Size(374, 40);
			this->title->TabIndex = 25;
			this->title->Text = L"スケジュール新規登録";
			// 
			// MyForm
			// 
